...
bool operator ==(Object other) {
  final _this = this as AppWebViewState;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppWebViewState&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.urlEditorController, _this.urlEditorController) || other.urlEditorController == _this.urlEditorController)&&(identical(other.webViewController, _this.webViewController) || other.webViewController == _this.webViewController)&&(identical(other.initialUrl, _this.initialUrl) || other.initialUrl == _this.initialUrl)&&(identical(other.title, _this.title) || other.title == _this.title)&&(identical(other.progress, _this.progress) || other.progress == _this.progress)&&(identical(other.pageStarted, _this.pageStarted) || other.pageStarted == _this.pageStarted)&&(identical(other.pageFinished, _this.pageFinished) || other.pageFinished == _this.pageFinished)&&(identical(other.currentUrl, _this.currentUrl) || other.currentUrl == _this.currentUrl)&&(identical(other.errorMessage, _this.errorMessage) || other.errorMessage == _this.errorMessage)&&(identical(other.javaScriptMessage, _this.javaScriptMessage) || other.javaScriptMessage == _this.javaScriptMessage)&&(identical(other.navigationDecision, _this.navigationDecision) || other.navigationDecision == _this.navigationDecision)&&(identical(other.canGoBack, _this.canGoBack) || other.canGoBack == _this.canGoBack)&&(identical(other.canGoForward, _this.canGoForward) || other.canGoForward == _this.canGoForward)&&(identical(other.expandTitleBar, _this.expandTitleBar) || other.expandTitleBar == _this.expandTitleBar)&&(identical(other.showDebugToolbar, _this.showDebugToolbar) || other.showDebugToolbar == _this.showDebugToolbar)&&const DeepCollectionEquality().equals(other.historyUrls, _this.historyUrls)&&const DeepCollectionEquality().equals(other.localStorageItems, _this.localStorageItems)&&const DeepCollectionEquality().equals(other.sessionStorageItems, _this.sessionStorageItems)&&(identical(other.stateStatus, _this.stateStatus) || other.stateStatus == _this.stateStatus));
}
...
int get hashCode {
  final _this = this as AppWebViewState;
  return Object.hashAll([runtimeType,_this.id,_this.urlEditorController,_this.webViewController,_this.initialUrl,_this.title,_this.progress,_this.pageStarted,_this.pageFinished,_this.currentUrl,_this.errorMessage,_this.javaScriptMessage,_this.navigationDecision,_this.canGoBack,_this.canGoForward,_this.expandTitleBar,_this.showDebugToolbar,const DeepCollectionEquality().hash(_this.historyUrls),const DeepCollectionEquality().hash(_this.localStorageItems),const DeepCollectionEquality().hash(_this.sessionStorageItems),_this.stateStatus]);
}

@override
String toString() {
  final _this = this as AppWebViewState;
  return 'AppWebViewState(id: ${_this.id}, urlEditorController: ${_this.urlEditorController}, webViewController: ${_this.webViewController}, initialUrl: ${_this.initialUrl}, title: ${_this.title}, progress: ${_this.progress}, pageStarted: ${_this.pageStarted}, pageFinished: ${_this.pageFinished}, currentUrl: ${_this.currentUrl}, errorMessage: ${_this.errorMessage}, javaScriptMessage: ${_this.javaScriptMessage}, navigationDecision: ${_this.navigationDecision}, canGoBack: ${_this.canGoBack}, canGoForward: ${_this.canGoForward}, expandTitleBar: ${_this.expandTitleBar}, showDebugToolbar: ${_this.showDebugToolbar}, historyUrls: ${_this.historyUrls}, localStorageItems: ${_this.localStorageItems}, sessionStorageItems: ${_this.sessionStorageItems}, stateStatus: ${_this.stateStatus})';
}
