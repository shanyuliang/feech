...
class AppWebViewWidget extends ConsumerWidget {
  ...
  AppWebViewWidget({super.key, int? id, String? initialUrl, String? title})
    : _appWebViewProvider = appWebViewStateProvider(id: id, initialUrl: initialUrl, title: title);
      ...
      body: Column(
        ...
        children: [
          Stack(
            ...
            children: [AppWebViewTitleBar(provider: _appWebViewProvider), AppWebViewProgressBar(provider: _appWebViewProvider)],
          ),
          Expanded(child: WebViewWidget(controller: ref.read(_appWebViewProvider).webViewController)),
        ],
      ),
    );
  }
