...
class _CameraMeta implements CameraMeta {
  const _CameraMeta({ List<CameraDescription>? cameraDescriptions, this.selectedCameraDescription, this.selectedCameraController, this.imagePath, this.stateStatus = StateStatus.initial}): _cameraDescriptions = cameraDescriptions;
