    ...
    await tester.pumpWidget(
      ProviderScope(
        child: AppInitialiseWidget(
          ...
          loadedChild: (_) => const MaterialApp(home: Material(child: Text("Loaded"))),
          loadingChild: (_) => const MaterialApp(home: Material(child: Text("Loading"))),
          loadErrorChild: (_) => const MaterialApp(home: Material(child: Text("Error"))),
